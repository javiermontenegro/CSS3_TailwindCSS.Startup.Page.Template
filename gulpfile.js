...
gulp.task('watch', function () {
    gulp.watch([paths.src.html.files, paths.src.scss.files], gulp.series(['html', 'scss'], 'browsersyncReload'));
...
gulp.task('default', gulp.series(gulp.parallel('clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs', 'html', 'scss', 'js', 'jsPages', 'html'), gulp.parallel('browsersync', 'watch')));
